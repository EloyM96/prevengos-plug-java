...
public final class EntityMappers {
    ...
    public static RespuestaPayload toPayload(RespuestaLocal local) {
        return new RespuestaPayload(local.getPreguntaCodigo(), local.getValor(), local.getUnidad(), local.getMetadata());
    }

    public static RespuestaLocal toLocal(RespuestaPayload payload) {
        return new RespuestaLocal(payload.getPreguntaCodigo(), payload.getValor(), payload.getUnidad(), payload.getMetadata());
    }
}
